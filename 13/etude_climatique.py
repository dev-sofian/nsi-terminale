...
def altitude_la_plus_froide(liste_altitudes, liste_temperatures):
    indice = 0
    liste_altitudes_froides = []
    for i in range(len(liste_temperatures)):
        if liste_temperatures[i] < liste_temperatures[indice]:
            indice = i
    for j in range(len(liste_altitudes)):
        if liste_temperatures[j] == liste_temperatures[indice]:
            liste_altitudes_froides.append(liste_altitudes[j])

    return (liste_temperatures[indice], liste_altitudes_froides)
